            ...
            null !== (n = $.trim(o)) && void 0 !== n && n.length) &&
              ((r = (t = o.split(/\n/)).map(function (n, t) {
                ...
                return (
                  ...
                  (u += "<td>".concat(n, "</td>")),
                  (u +=
                    '<td style="text-align: center;"><div class="gb-flex gb-flex-col gb-space-y-2">\n                <a href="'
                      .concat(
                        (function (n) {
                          return (
                            (i
                        ...
                        '" target="_blank" class="btn btn-success  btn-sm btn-share btn-opsi"><i class="fa fa-brands fa-whatsapp"></i> Whatsapp</a>\n      <a href="http://www.facebook.com/sharer/sharer.php?u='
                      )
                      .concat(r, "&quote=")
                      .concat(
                        r,
                        '" target="_blank" class="btn btn-sm btn-share btn-info btn-opsi"><i class="fa-brands fa-facebook"></i></i> Facebook</a>\n           <button data-action="copy" data-clipboard-text="'
                      )
                      .concat(
                        r,
                        '" class="btn btn-sm btn-dark gb-btn-copy btn-opsi"><i class="fa-regular fa-copy"></i> Link</button>\n                <button data-action="copy" data-clipboard-text="'
                      )
                      .concat(
                        e,
                        '" class="btn btn-dark btn-sm gb-btn-copy btn-opsi copy-btn"><i class="fa-regular fa-copy"></i>Copy</button>\n                <button data-action="delete"  type="button"  class="btn btn-sm btn-danger gb-delete-row btn-opsi"><i class="fa fa-trash-can"></i></button>\n                </div></td>'
                      )),
                  (u += "</tr>")
                );
              })),
